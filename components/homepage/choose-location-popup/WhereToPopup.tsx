        ...
        <div className="where-to-popup-wrapper">
          <div className="where-to-popup__element where-to-popup__element--location flex flex-align-center">
            ...
            <div className="where-to-popup__element__data">
              <span className="where-to-popup__element__data-span">Eiffel Tower</span>
              <p className="where-to-popup__element__data-country">France</p>
            </div>
          </div>
          <div className="where-to-popup__element where-to-popup__element--tour flex flex-align-center">
            <div className="where-to-popup__element__image-wrapper">
              <img className="where-to-popup__element__image" src={whereToImg1.src}
                   alt="tour destination image" />
            </div>
            <div className="where-to-popup__element__data">
        <span
          className="where-to-popup__element__data-span">Eiffel Tower Guided Climb with Optional Summit Access</span>
              <p className="where-to-popup__element__data-country">France | From 32.98$</p>
            </div>
          </div>
          <div className="where-to-popup__element where-to-popup__element--tour flex flex-align-center">
            <div className="where-to-popup__element__image-wrapper">
              <img className="where-to-popup__element__image" src={whereToImg2.src}
                   alt="tour destination image" />
            </div>
            <div className="where-to-popup__element__data">
        <span
          className="where-to-popup__element__data-span">Skip-the-Line Eiffel Tower Tour and Seine River Cruise</span>
              <p className="where-to-popup__element__data-country">France | From 32.98$</p>
            </div>
          </div>
          <div className="where-to-popup__element where-to-popup__element--tour flex flex-align-center">
            <div className="where-to-popup__element__image-wrapper">
              <img className="where-to-popup__element__image" src={whereToImg3.src}
                   alt="tour destination image" />
            </div>
            <div className="where-to-popup__element__data">
        <span
          className="where-to-popup__element__data-span">Eiffel Tower Dinner Experience with Summit Option</span>
              <p className="where-to-popup__element__data-country">France | From 32.98$</p>
            </div>
          </div>
          <div className="where-to-popup__element where-to-popup__element--tour flex flex-align-center">
            <div className="where-to-popup__element__image-wrapper">
              <img className="where-to-popup__element__image" src={whereToImg4.src}
                   alt="tour destination image" />
            </div>
            <div className="where-to-popup__element__data">
        <span
          className="where-to-popup__element__data-span">Eiffel Tower Night Tour with Optional Champagne Toast</span>
              <p className="where-to-popup__element__data-country">France | From 32.98$</p>
            </div>
          </div>
          <div className="where-to-popup__element where-to-popup__element--tour flex flex-align-center">
            <div className="where-to-popup__element__image-wrapper">
              <img className="where-to-popup__element__image" src={whereToImg5}
                   alt="tour destination image" />
            </div>
            <div className="where-to-popup__element__data">
        <span
          className="where-to-popup__element__data-span">Exclusive Eiffel Tower History Walk with Summit Access</span>
              <p className="where-to-popup__element__data-country">France | From 32.98$</p>
            </div>
          </div>
          <div className="where-to-popup__element where-to-popup__element--tour flex flex-align-center">
            <div className="where-to-popup__element__image-wrapper">
              <img className="where-to-popup__element__image" src={whereToImg6}
                   alt="tour destination image" />
            </div>
            <div className="where-to-popup__element__data">
        <span
          className="where-to-popup__element__data-span">Eiffel Tower Access to 2nd Floor and Summit Option with Host</span>
              <p className="where-to-popup__element__data-country">France | From 32.98$</p>
            </div>
          </div>
          <div className="where-to-popup__element flex flex-align-center">
            ...
            <div className="where-to-popup__element__data">
              <span className="where-to-popup__element__data-see-all">See all results for &quot;<span
                className="where-to-popup__element__data-span user-search-input">Eiffel</span>&quot;</span>
            </div>
          </div>
        </div>
      </div>
