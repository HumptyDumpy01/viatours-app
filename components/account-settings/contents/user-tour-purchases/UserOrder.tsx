      ...
      <motion.div
          ...
          <AnimatePresence>
            {!openCard && (
              <UserOrderCardFront
                ...
                openCard={openCard}
                viewportIsLessThan593px={viewportIsLessThan593px}
              />
            )}
          </AnimatePresence>
          <AnimatePresence>
        ...
        <div className="tour-purchases__card-details-1">
          ...
          <div className="tour-purchases__card-details-1__amount-of-tickets flex gap-sm flex-align-center">
            <p className="tour-purchases__card-details-1__amount-of-tickets-title">Amount of tickets:</p>
            <p className="tour-purchases__card-details-1__amount-of-tickets-count">{order.tickets.overall}</p>
          </div>
          ...
          <div className="tour-purchases__card-details-1__tickets">
            <div className="tour-purchases__card-details-1__tickets-child flex gap-sm flex-align-center">
              ...
              <p className="tour-purchases__card-details-1__tickets-adult-count">{order.tickets.childrenTickets}</p>
            </div>
          </div>
        ...
        {/*THIRD COLUMN*/}
        <div className="tour-purchases__card-details-2">
          <div
            className="tour-purchases__card-details-2__status margin-top-3rem flex flex-direction-column">
            <p className="tour-purchases__card-details-2__status-title uppercase">Status</p>
            <p
              className="tour-purchases__card-details-2__status-info uppercase booked status-state">{order.extraDetails.state.status}</p>
          </div>
          <div
