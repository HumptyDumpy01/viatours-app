...
export default function ArticleContentCard({ imgUrl, tag, country, readTime, title }: ArticleContentCardType) {
  return (
    <>
      <Link href="#" className="link travel-articles__card-hover">
        <figure className="travel-articles__the-top-articles__card">
          <span className="inline-block travel-articles__the-top-articles-tag">Culture</span>
          <div className="travel-articles__the-top-articles__card-img">
            <img src={imgUrl}
                 alt="top articles dummy image"
          ...
          <div className="travel-articles__the-top-articles__card-info">
            ...
            <div className="travel-articles__the-top-articles__card-info__author">
              <p className="travel-articles__the-top-articles__card-info__author__p">By Nick Baker</p>
            </div>
          </div>
        </figure>
      </Link>
