...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const result = await sendEmail({
      ...
      <p>You can track your dummy order <a href='http://localhost:3000/track-order'>here.</a></p>
      <p>If you registered an account, you can track your order directly by visiting the Account Settings page: <a href='http://localhost:3000/account-details/my-purchases'>
      here.</a></p>
      <div>
      ...
      <p>You can see Meeting Point on map while <a href="http://localhost:3000/track-order"> tracking the order.<a/></p>
      ...
      <button style="background-color: #EB662B; color: white;
       font-family: Montserrat, serif;
        ...
        margin-top: 1rem;
           ">
      <a href="http://localhost:3000/track-order" style="text-decoration: none; color: white;">Track Order</a></button>
      </div>
      <p>Best Regards, Nikolas.</p>
      </div>
      `
